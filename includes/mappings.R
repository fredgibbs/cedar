...
AFST_reqs <- c("AFST_BA_major" = AFST_BA_major, "AFST_BA_sec_maj" = AFST_BA_sec_maj, "AFST_BA_minor" = AFST_BA_minor)

test_if_req <- function (course) {
  lookup <- unlist(AFST_reqs)
  #names(lookup)[matches(course,lookup)]
  #names(lookup)[course %in% lookup]
  }

test_if_req("AFST 1110")
test_if_req("AFST 498")

AFST_reqs <- list(
  "AFST 1110" = c("AFST_BA_major","AFST_BA_sec_maj","AFST_BA_minor"),
  "AFST 2110" = c("AFST_BA_major","AFST_BA_sec_maj","AFST_BA_minor"),
  "AFST 398" = c("AFST_BA_major","AFST_BA_sec_maj","AFST_BA_minor"),
  "AFST 498"= c("AFST_BA_major","AFST_BA_sec_maj")
)


# PADM_reqs <- list(
#   "PADM 500" = c("PADM_Grad_minor","AFST_BA_sec_maj","AFST_BA_minor"),
#   "AFST 2110" = c("AFST_BA_major","AFST_BA_sec_maj","AFST_BA_minor"),
#   "AFST 398" = c("AFST_BA_major","AFST_BA_sec_maj","AFST_BA_minor"),
#   "AFST 498"= c("AFST_BA_major","AFST_BA_sec_maj")
# )
