count_degrees <- function() {
  ...
  degrees <- degrees %>% select(`Academic Period Code`,College,ID,`Student Last Name`, Department,Program,`Program Code`,`Award Category`,Degree, Major, `Major Code`,`Second Major`, `First Minor`,`Second Minor`)
