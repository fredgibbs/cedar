...
```{r fall_enrl, results="asis", echo=FALSE} 
    ...
    cols <- c("TERM","enrolled","sections","avg_size","avail","waiting","count","mean_attr","squeeze")
...
```{r gradebook, results="asis", echo=FALSE} 
    ...
    cols <- c("TERM","SUBJ_CRSE","enrolled","cl_total", "sections", "avg_size", "avail","conduit","major","c_accr","m_accr","m_cl_accr","num_sections","diff_fr_prev")
