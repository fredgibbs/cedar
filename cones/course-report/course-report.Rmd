...
```{r fall_enrl, results="asis", echo=FALSE} 
    ...
    cols <- c("TERM","enrolled","sections","avg_size","avail","waiting","drops","mean_drops","squeeze")
...
```{r gradebook, results="asis", echo=FALSE} 
    ...
    cols <- c("TERM","SUBJ_CRSE","enrolled","cl_total", "sections", "avg_size", "avail","conduit","major","c_accr","m_accr","m_cl_accr","rec_sections","diff_fr_prev")
