...
```{r echo=FALSE} 
  squeezes <- squeezes %>% select(TERM,SUBJ_CRSE,CRSE_TITLE,enrolled,sections,avg_size,avail,waiting,gen_ed_area,de_mean,dl_mean,da_mean,squeeze)
  
  colnames(squeezes) <- c("TERM","SUBJ_CRSE","CRSE_TITLE","ENRL","SECTS","SECT_SIZE","AVAIL","WAIT","GE_AREA","DE_MEAN","DL_MEAN","DA_MEAN","SQUEEZE")
